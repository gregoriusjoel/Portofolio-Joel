...
export const projects = [
  {
    ...
    image: "/src/assets/project/Bisindo/homepage.png",
    demo: "#",
    github: "#",
    screenshots: [
      "/src/assets/project/Bisindo/homepage.png",
      "/src/assets/project/Bisindo/about.png",
      "/src/assets/project/Bisindo/cam.png",
      "/src/assets/project/Bisindo/stream.png"
    ],
    status: "completed",
  ...
  },
  {
    ...
    image: "/src/assets/project/Kasir Ayam Geprek/login.png",
    demo: "#",
    github: "https://github.com/gregoriusjoel/POS",
    screenshots: [
      "/src/assets/project/Kasir Ayam Geprek/login.png",
      "/src/assets/project/Kasir Ayam Geprek/dashboard.png",
      "/src/assets/project/Kasir Ayam Geprek/daftarmenu.png",
      "/src/assets/project/Kasir Ayam Geprek/pos.png",
      "/src/assets/project/Kasir Ayam Geprek/riwayattransaksi.png"
    ],
    status: "completed",
  ...
  },
  {
    ...
    image: "/src/assets/project/Vameratale/homepage.png",
    demo: "#",
    github: "#",
    screenshots: [
      "/src/assets/project/Vameratale/homepage.png",
      "/src/assets/project/Vameratale/kategori.png",
      "/src/assets/project/Vameratale/detail.png",
      "/src/assets/project/Vameratale/cart.png",
      "/src/assets/project/Vameratale/payment.png",
      "/src/assets/project/Vameratale/login.png",
      "/src/assets/project/Vameratale/daftar.png",
      "/src/assets/project/Vameratale/about.png",
      "/src/assets/project/Vameratale/invocie.png"
    ],
    status: "completed",
  ...
  },
  {
    ...
    image: "/src/assets/project/Petrikor/homepage.png",
    demo: "https://petrikor.vercel.app/",
    github: "#",
    screenshots: [
      "/src/assets/project/Petrikor/homepage.png"
    ],
    status: "completed",
  ...
  },
  {
    ...
    image: "/src/assets/project/Klinik Gudang/login.png",
    demo: "https://gudang-klinik-pratama.vercel.app/",
    github: "#",
    screenshots: [
      "/src/assets/project/Klinik Gudang/login.png",
      "/src/assets/project/Klinik Gudang/DASHBOARD.png",
      "/src/assets/project/Klinik Gudang/HALAMAN STOK.png",
      "/src/assets/project/Klinik Gudang/HALAMAN BARANG MASUK.png",
      "/src/assets/project/Klinik Gudang/HALAMAN BARANG KELUAR.png",
      "/src/assets/project/Klinik Gudang/STOK ALERT.png",
      "/src/assets/project/Klinik Gudang/LAPORAN HARIAN.png",
      "/src/assets/project/Klinik Gudang/REQUEST BARANG.png",
      "/src/assets/project/Klinik Gudang/DASHBOARD KARYAWAN.png",
      "/src/assets/project/Klinik Gudang/REQUEST BARANG KARYAWAN.png"
    ],
    status: "completed",
  ...
  },
  {
    ...
    image: "/src/assets/project/Access Careers/Landing Page.png",
    ...
    github: "#",
    screenshots: [
      "/src/assets/project/Access Careers/Landing Page.png",
      "/src/assets/project/Access Careers/Homepage.png",
      "/src/assets/project/Access Careers/Fitur.png",
      "/src/assets/project/Access Careers/Mitra.png",
      "/src/assets/project/Access Careers/Tips.png",
      "/src/assets/project/Access Careers/Daftar.png",
      "/src/assets/project/Access Careers/Login.png",
      "/src/assets/project/Access Careers/Filter.png",
    ],
    status: "completed",
