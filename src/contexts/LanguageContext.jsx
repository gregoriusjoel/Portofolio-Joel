...
const translations = {
  id: {
    ...
    availableForWork: 'Tersedia untuk Project',
    location: 'Indonesia',
    coreValues: 'Nilai & Prinsip Kerja',
    valTitle1: 'Desain Berpusat Pada Pengguna',
    valDesc1: 'Menggabungkan estetika visual modern dengan struktur interaksi intuitif untuk pengalaman pengguna terbaik.',
    valTitle2: 'Kode Bersih & Terstruktur',
    valDesc2: 'Menulis kode yang rapi, modular, mudah dirawat, dan mematuhi best practices industri serta standar SEO.',
    valTitle3: 'Komunikasi & Kolaborasi',
    valDesc3: 'Komunikasi transparan, tanggap terhadap kebutuhan proyek, dan berkomitmen memberikan hasil tepat waktu.',
    allCategory: 'Semua',
  ...
  en: {
    ...
    location: 'Indonesia',
    coreValues: 'Core Values & Principles',
    valTitle1: 'User-Centered Design',
    valDesc1: 'Combining modern visual aesthetics with intuitive interaction structures for the best user experience.',
    valTitle2: 'Clean & Structured Code',
    valDesc2: 'Writing tidy, modular, maintainable code adhering to industry best practices and SEO standards.',
    valTitle3: 'Communication & Collaboration',
    valDesc3: 'Transparent communication, adaptable to project needs, and committed to timely deliverables.',
    allCategory: 'All',
    frontendCategory: 'Frontend & UI/UX',
    backendCategory: 'Backend & Data',
    mobileCategory: 'Mobile',
    ...
    networkError: 'Internet connection issue. Please try again.',
